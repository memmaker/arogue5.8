...
parts.append(section('about', 'About the game',
                     guide.pop('How Advanced Rogue differs from Angband')))
...
parts.append('<h2 id="h-version">About this version</h2><ul>'
             '<li>Based on <strong>Advanced Rogue 5.8.2</strong> (Michael Morgan, Ken Dalka).</li>'
             ...
             '<li>Original source: <a href="https://github.com/RoguelikeRestorationProject/arogue5.8/tree/49b1289" target="_blank" rel="noopener">RoguelikeRestorationProject/arogue5.8, commit 49b1289</a></li>'
             '<li>Our changes (port, auto-explore, command menu, web build): '
             '<a href="https://github.com/memmaker/arogue5.8/compare/49b1289...master" target="_blank" rel="noopener">memmaker/arogue5.8, compared with the original</a></li></ul>')
print('\n'.join(parts))
